...
names = [
    ...
    'edge_labels', 'edge_attributes', 'graph_labels', 'graph_attributes','sort_index'
]
...
def read_tu_data(
    ...
    if 'node_attributes' in names:
        ...
        # # 2024年4月15日 对其进行逐列归一化
        # node_attribute = torch.nn.functional.normalize(node_attribute,p=2,dim=0)
